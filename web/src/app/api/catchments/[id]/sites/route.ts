...
// GET /api/catchments/:id/sites. Brownfield development sites inside the
// catchment, for the Find a site overlay.
export async function GET(
  ...
  const res = await fetch(`${WORKER_BASE_URL}/catchments/${params.id}/sites`, {
